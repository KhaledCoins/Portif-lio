...
const translations = {
  pt: {
    computerScience: 'Estudante de Ciência da Computação',
    age: '19 anos',
    quote: 'Atuando na interseção entre tecnologia e negócios para criar soluções de impacto',
    viewProjects: 'Ver Projetos',
    contact: 'Entre em Contato'
  },
  en: {
    computerScience: 'Computer Science Student',
    age: '19 years old',
    quote: 'Working at the intersection of technology and business to create impactful solutions',
