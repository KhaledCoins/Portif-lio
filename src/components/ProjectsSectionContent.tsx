...
const translations = {
  pt: {
    title: 'Projetos',
    subtitle: 'Uma seleção dos meus projetos acadêmicos e pessoais que demonstram minhas habilidades em desenvolvimento',
  ...
  en: {
    title: 'Projects',
    subtitle: 'A selection of my academic and personal projects that demonstrate my development skills',
    viewAllProjects: 'View All Projects on GitHub',
    codeLabel: 'Code',
    demoLabel: 'Demo',
    projects: [
      {
        title: "Ethereum Mining Rig - 24 GPUs",
        description: "Independent construction and operation of an Ethereum mining rig with 24 graphics cards. Complete project including hardware, configuration, optimization and energy management for cryptocurrency mining.",
        image: "https://images.unsplash.com/photo-1667808929648-a3633dadf9e3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxldGhlcmV1bSUyMG1pbmluZyUyMGNyeXB0b2N1cnJlbmN5JTIwaGFyZHdhcmV8ZW58MXx8fHwxNzU4ODIzMzkzfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
        technologies: ["Hardware", "Ethereum", "GPU Mining", "Energy Optimization"],
        github: null,
        demo: null
      },
      {
        title: "Data Guardians - LGPD Game",
        description: "Development of educational digital game 'Data Guardians' in partnership with Google for Education. Objective: raise awareness among students and teachers about LGPD, security and data privacy through a gamified experience.",
        image: dataGuardiansImage,
        technologies: ["JavaScript", "Phaser.js", "LGPD", "UX Design", "Gamification"],
        github: "https://inteli-college.github.io/2025-1A-T19-IN01-G02/",
        demo: "#"
      },
      {
        title: "USP Web Application - Health",
        description: "Full stack project in partnership with the University of São Paulo Medical School. Connects patients with chronic wounds to healthcare professionals in UBSs, facilitating remote monitoring.",
        image: uspMedicinaImage,
        technologies: ["Full Stack", "JavaScript", "PostgreSQL", "UX Research"],
        github: "https://github.com/KhaledCoins",
        demo: "#"
      ...
      {
        title: "Fintech Consulting - Kuboo",
        description: "Provided specialized consulting in strategic analysis for financial sector technological solutions, contributing to innovation processes and organizational growth.",
        image: kubooLogo,
        technologies: ["PostgreSQL", "Strategic Analysis", "Fintech"],
        github: null,
        demo: null
      },
      {
        title: "International Robotics Competition",
        description: "Complete robot development for First Robotics Competition for 4 years. Programming, electronics, mechanics and prototyping. Represented Brazil in the USA.",
        image: roboticsImage,
        technologies: ["Java", "C++", "SolidWorks", "LabVIEW", "Electronics"],
        github: "https://github.com/KhaledCoins",
        alphabots: "https://www.thebluealliance.com/team/1860",
        demo: null
      },
      {
        title: "AI System for 2025 Hackathon",
        description: "Innovative artificial intelligence solution developed during 2025 hackathon, focused on solving real market problems with data analysis and KPIs.",
        image: hackathonImage,
        technologies: ["Python", "Machine Learning", "Excel"],
        github: "https://github.com/m4rcusml/documentacao-hackathon-inteli",
        lidaris: "https://chatgpt.com/g/g-679acb4e112c81918ce99683f801e8bb-lidaris?model=gpt-4o",
            ...
            >
              ...
              <div className="relative overflow-hidden">
                <ImageWithFallback
                  src={project.image}
                  alt={project.title}
                  className={`w-full h-48 ${project.title.includes("Robótica") || project.title.includes("Robotics") ? "object-contain bg-black" : "object-cover"} group-hover:scale-105 transition-transform duration-300`}
                />
              </div>
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3">
                  {project.github && !project.title.includes("Robótica") && !project.title.includes("Robotics") && (
                    <a
                      href={project.github}
                      target="_blank"
