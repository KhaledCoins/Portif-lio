...
const translations = {
  pt: {
    title: 'Experiência',
    subtitle: 'Minha trajetória profissional e acadêmica na interseção entre tecnologia e negócios',
    objectiveTitle: 'Objetivo Profissional',
    objectiveText: 'Atuar na interseção entre tecnologia e negócios, contribuindo para o desenvolvimento de soluções digitais que gerem valor estratégico para empresas. Busco aplicar conhecimentos em análise de dados, inovação e gestão de projetos para apoiar a tomada de decisão e impulsionar o crescimento organizacional.',
    experiences: [
      {
        type: 'work',
  ...
  en: {
    title: 'Experience',
    subtitle: 'My professional and academic journey at the intersection of technology and business',
    objectiveTitle: 'Professional Goal',
    objectiveText: 'To work at the intersection of technology and business, contributing to the development of digital solutions that generate strategic value for companies. I seek to apply knowledge in data analysis, innovation, and project management to support decision-making and drive organizational growth.',
    experiences: [
      {
        type: 'work',
        title: 'Kuboo Financial Solutions',
        role: 'Analysis Consultant',
        period: '2024',
        description: 'Provided specialized consulting in strategic analysis for financial sector solutions, contributing to technological development and innovation projects.',
        skills: ['Asset Analysis', 'Applied Economics', 'PostgreSQL', 'Strategic Analysis', 'Fintech']
      },
      {
        type: 'education',
        title: 'Insper - Institute of Education and Research',
        role: 'Computer Science',
        period: '2025 - 2029',
        description: 'Bachelor\'s degree in Computer Science with focus on developing technological solutions and business analysis.',
        skills: ['Algorithms', 'Data Structures', 'Web Development', 'Business Analytics']
      },
      {
        type: 'education',
        title: 'INTELI - Institute of Technology and Leadership',
        role: 'Computer Science',
        period: '2025 - 2028 (Partial)',
        description: 'During my time at INTELI, I developed projects in partnership with Google for Education and the University of São Paulo Medical School.',
        skills: ['Project Management', 'Innovation', 'Leadership', 'Strategic Partnerships']
      },
      {
        type: 'achievement',
        title: 'Scientific Olympiads',
        role: '23 Medals in High School',
        period: '2020 - 2024',
        description: 'Achieved 23 medals in scientific olympiads, including gold in OBRL and OBA, silver in OBR and Singa Math, international selections for IOAA and Conesul, plus participation in question banks.',
        skills: ['Problem Solving', 'Analytical Thinking', 'Mathematics', 'Astronomy', 'Robotics']
      },
      {
        type: 'achievement',
        title: 'FRC Alphabots 1860',
        ...
        period: '2019 - 2023',
        description: 'Participated for 4 years in the FRC robotics team, including 3 representations of Brazil in international competitions in the USA and networking at some of the top 10 universities in the United States.',
        skills: ['Robotics', 'SolidWorks', 'Electronics', 'Teamwork', 'International Networking', 'International Competition']
      }
    ]
  }
};
